...
<div id="container">
    ...
    <form action="includes/insert_patient.php" method="post">
        ...
        <input type="text" name="p_name" id="product_name" required>

        <label for="product_stocks">Patient Email:</label>
        <input type="email" name="p_email" id="product_stocks" required>
